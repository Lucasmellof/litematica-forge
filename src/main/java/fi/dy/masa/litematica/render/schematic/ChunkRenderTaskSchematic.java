...
public class ChunkRenderTaskSchematic implements Comparable<ChunkRenderTaskSchematic> {
    ...
    public ChunkRenderTaskSchematic(
            ChunkRendererSchematicVbo renderChunkIn,
            ChunkRenderTaskSchematic.Type typeIn,
            Supplier<Vec3> cameraPosSupplier,
            double distanceSqIn) {
    ...
    public void finish() {
        ...
        try {
            if (this.type == ChunkRenderTaskSchematic.Type.REBUILD_CHUNK
