            ...
            if (this.type == ButtonType.SAVE) {
                ...
                if (this.gui.schematic != null) {
                    ...
                    if (area != null) {
                        ...
                        // The file name extension gets added in the schematic write method, so need to add it here for
                        // the check
                        ...
                        LitematicaSchematic.SchematicSaveInfo info = new LitematicaSchematic.SchematicSaveInfo(
                                visibleOnly, ignoreEntities, fromSchematicWorld);
                        ...
                        this.gui.addMessage(
                                MessageType.ERROR, "litematica.message.error.schematic_save_no_area_selected");
                    }
                }
            }
        }
    ...
    public static class InMemorySchematicCreator implements IStringConsumer {
        ...
        public void setString(String string) {
            LitematicaSchematic.SchematicSaveInfo info =
                    new LitematicaSchematic.SchematicSaveInfo(false, false); // TODO
