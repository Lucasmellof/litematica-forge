...
public class GuiPlacementConfiguration
    ...
    public void initGui() {
        ...
        String label = StringUtils.translate(
                "litematica.gui.label.schematic_placement.sub_regions", this.placement.getSubRegionCount());
    ...
    public int createButton(int x, int y, int width, ButtonListener.Type type) {
        ...
        switch (type) {
            case TOGGLE_ENCLOSING_BOX: {
                Icons icon = this.placement.shouldRenderEnclosingBox()
                        ? Icons.ENCLOSING_BOX_ENABLED
                        : Icons.ENCLOSING_BOX_DISABLED;
                boolean enabled = this.placement.shouldRenderEnclosingBox();
                String str = (enabled ? TXT_GREEN : TXT_RED)
                        + StringUtils.translate("litematica.message.value." + (enabled ? "on" : "off"))
                        + TXT_RST;
                String hover =
                        StringUtils.translate("litematica.gui.button.schematic_placement.hover.enclosing_box", str);
            ...
            case TOGGLE_RENDERING: {
                ...
                String str =
                        pre + StringUtils.translate("litematica.message.value." + (enabled ? "on" : "off")) + TXT_RST;
    ...
    public void onSelectionChange(SubRegionPlacement entry) {
        this.placement.setSelectedSubRegionName(
                entry != null && !entry.getName().equals(this.placement.getSelectedSubRegionName())
                        ? entry.getName()
                        : null);
    }
    ...
    public static class ButtonListener implements IButtonActionListener {
        ...
        public void actionPerformedWithButton(ButtonBase button, int mouseButton) {
            ...
            switch (this.type) {
                ...
                case TOGGLE_ALL_REGIONS_OFF: {
                    ...
                    this.placement.setSubRegionsEnabledState(
                            state, this.parent.getListWidget().getCurrentEntries(), this.parent);
                    break;
                }
        ...
        public enum Type {
            ...
            TOGGLE_LOCKED(
                    "litematica.gui.button.schematic_placements.locked",
                    "litematica.gui.button.schematic_placement.hover.lock"),
