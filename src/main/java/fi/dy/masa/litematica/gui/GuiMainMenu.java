...
public class GuiMainMenu extends GuiBase {
    ...
    public void initGui() {
        ...
        label = StringUtils.translate(
                "litematica.gui.button.tool_mode", DataManager.getToolMode().getName());
    ...
    public static class ButtonListenerChangeMenu implements IButtonActionListener {
        ...
        public enum ButtonType {
            ...
            LOADED_SCHEMATICS(
                    "litematica.gui.button.change_menu.show_loaded_schematics", ButtonIcons.LOADED_SCHEMATICS),
            // List Schematics placements
            SCHEMATIC_PLACEMENTS(
                    "litematica.gui.button.change_menu.show_schematic_placements", ButtonIcons.SCHEMATIC_PLACEMENTS),
            // Open the Area Selection browser
            AREA_SELECTION_BROWSER(
                    "litematica.gui.button.change_menu.show_area_selections", ButtonIcons.AREA_SELECTION),
            ...
            LOAD_SCHEMATICS(
                    "litematica.gui.button.change_menu.load_schematics_to_memory", ButtonIcons.SCHEMATIC_BROWSER),
            ...
            SCHEMATIC_PROJECTS_MANAGER(
                    "litematica.gui.button.change_menu.schematic_projects_manager", ButtonIcons.SCHEMATIC_PROJECTS),
