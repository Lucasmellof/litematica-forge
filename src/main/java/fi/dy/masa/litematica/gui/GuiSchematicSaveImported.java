            ...
            if (this.type == ButtonType.SAVE) {
                ...
                if (this.gui.type == DirectoryEntryType.FILE) {
                    ...
                    if (fileType == FileType.SCHEMATICA_SCHEMATIC) {
                        if (WorldUtils.convertSchematicaSchematicToLitematicaSchematic(
                ...
                this.gui.addMessage(
                        MessageType.ERROR, "litematica.error.schematic_load.unsupported_type", this.gui.inputFileName);
            }
        }
    }
}
