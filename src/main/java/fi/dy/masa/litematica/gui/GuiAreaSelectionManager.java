...
public class GuiAreaSelectionManager
        extends GuiListBase<DirectoryEntry, WidgetDirectoryEntry, WidgetAreaSelectionBrowser>
    ...
    public void initGui() {
        ...
        if (this.selectionManager.getSelectionMode() == SelectionMode.SIMPLE) {
            InfoUtils.showGuiMessage(
                    MessageType.WARNING, "litematica.message.warn.area_selection.browser_open_in_simple_mode");
        }
    }
    ...
    protected void reCreateGuiElements() {
        ...
        ButtonGeneric button =
                new ButtonGeneric(10, y, -1, 20, StringUtils.translate(type.getLabelKey()), type.getIcon());
        ...
        if (currentSelection != null) {
            int len = DataManager.getAreaSelectionsBaseDirectory()
                    .getAbsolutePath()
                    .length();
            ...
            if (currentSelection.length() > len + 1) {
                ...
                String str = StringUtils.translate(
                        "litematica.gui.label.area_selection_manager.current_selection", currentSelection);
            ...
            if (this.type == ButtonType.NEW_SELECTION) {
                ...
                if (placement != null) {
                    ...
                    GuiBase.openGui(new GuiTextInput(
                            ...
                            placement.getName(),
                            this.gui,
                            new SelectionCreatorPlacement(placement, dir, this.gui)));
                } else {
