...
public class WidgetListPlacementSubRegions extends WidgetListBase<SubRegionPlacement, WidgetPlacementSubRegion> {
    ...
    @Override
    protected WidgetPlacementSubRegion createListEntryWidget(
            int x, int y, int listIndex, boolean isOdd, SubRegionPlacement entry) {
        return new WidgetPlacementSubRegion(
                x,
                y,
                this.browserEntryWidth,
                this.getBrowserEntryHeightFor(entry),
                isOdd,
                this.parent.getSchematicPlacement(),
                entry,
                listIndex,
                this);
    }
