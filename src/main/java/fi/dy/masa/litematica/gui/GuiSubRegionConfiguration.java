...
public class GuiSubRegionConfiguration extends GuiBase {
    ...
    public void initGui() {
        ...
        String label =
                StringUtils.translate("litematica.gui.label.placement_sub.region_name", this.placement.getName());
        ...
        this.addButton(
                button,
                new ButtonListener(
                        ButtonListener.Type.PLACEMENT_CONFIGURATION, this.schematicPlacement, this.placement, this));
    ...
    private void createCoordinateInput(int x, int y, int width, CoordinateType type) {
        ...
        pos = PositionUtils.getTransformedBlockPos(
                pos, this.schematicPlacement.getMirror(), this.schematicPlacement.getRotation());
    ...
    private static class ButtonListener implements IButtonActionListener {
        ...
        public ButtonListener(
                Type type, SchematicPlacement schematicPlacement, SubRegionPlacement placement, GuiBase parent) {
            this.type = type;
            this.schematicPlacement = schematicPlacement;
            this.placement = placement;
            this.parent = parent;
        ...
        public void actionPerformedWithButton(ButtonBase button, int mouseButton) {
            ...
            posOld = PositionUtils.getTransformedBlockPos(
                    posOld, this.schematicPlacement.getMirror(), this.schematicPlacement.getRotation());
            ...
            switch (this.type) {
                ...
                case MOVE_TO_PLAYER:
                    this.schematicPlacement.moveSubRegionTo(
                            this.subRegionName, new BlockPos(this.parent.mc.player.position()), this.parent);
                    break;

                case NUDGE_COORD_X:
                    this.schematicPlacement.moveSubRegionTo(
                            this.subRegionName, posOld.offset(amount, 0, 0), this.parent);
                    break;

                case NUDGE_COORD_Y:
                    this.schematicPlacement.moveSubRegionTo(
                            this.subRegionName, posOld.offset(0, amount, 0), this.parent);
                    break;

                case NUDGE_COORD_Z:
                    this.schematicPlacement.moveSubRegionTo(
                            this.subRegionName, posOld.offset(0, 0, amount), this.parent);
                    break;
