...
public class WidgetTaskEntry extends WidgetListEntryBase<ITask> {
    ...
    public WidgetTaskEntry(
            int x, int y, int width, int height, boolean isOdd, ITask task, int listIndex, WidgetListTasks parent) {
        ...
        this.addButton(
                new ButtonGeneric(posX, y + 1, -1, true, StringUtils.translate("litematica.gui.button.remove")),
                listener);
    }
